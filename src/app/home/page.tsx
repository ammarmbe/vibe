					...
					<ul className="grid grid-cols-1 grid-rows-6 md:grid-cols-3 md:grid-rows-2 gap-8 max-w-7xl mx-auto">
						<li className="flex flex-col gap-2.5 p-6 border text-center rounded-md shadow-md">
							<div className="w-full flex mb-3.5 justify-center">
								<UserCircle2 className="text-accent" size={64} />
							</div>
							<h3
						...
						<li className="flex flex-col gap-2.5 p-6 border text-center rounded-md shadow-md">
							<div className="w-full flex mb-3.5 justify-center">
								<Database className="text-accent" size={64} />
							</div>
							<h3
								className={`md:text-3xl text-2xl ${jetBrains.className} text-main font-bold`}
							>
						...
						<li className="flex flex-col gap-2.5 p-6 border text-center rounded-md shadow-md">
							<div className="w-full flex mb-3.5 justify-center">
								<MessageSquarePlus className="text-accent" size={64} />
							</div>
							<h3
								className={`md:text-3xl text-2xl ${jetBrains.className} text-main font-bold`}
							>
						...
						<li className="flex flex-col gap-2.5 p-6 border text-center rounded-md shadow-md">
							<div className="w-full flex mb-3.5 justify-center">
								<Users2 className="text-accent" size={64} />
							</div>
							<h3
								className={`md:text-3xl text-2xl ${jetBrains.className} text-main font-bold`}
							>
						...
						<li className="flex flex-col gap-2.5 p-6 border text-center rounded-md shadow-md">
							<div className="w-full flex mb-3.5 justify-center">
								<BellRing className="text-accent" size={64} />
							</div>
							<h3
								className={`md:text-3xl text-2xl ${jetBrains.className} text-main font-bold`}
							>
					...
					<ul className="grid grid-cols-1 grid-rows-6 md:grid-cols-3 md:grid-rows-2 gap-8 max-w-7xl mx-auto">
						...
						<li>
							...
							>
								...
								<h3 className="text-2xl font-semibold">Datebasejs (MySQL)</h3>
							</Link>
						</li>
						<li>
							<Link
